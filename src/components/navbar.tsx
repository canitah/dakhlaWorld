    ...
    if (!showDashboardNav) {
        ...
        return (
            <>
                <header className="sticky top-0 z-30 py-3 px-4 md:px-8 bg-background/60 backdrop-blur-md">
                    <div className="max-w-7xl mx-auto bg-card/90 backdrop-blur-xl border border-border rounded-full px-4 md:px-6 py-2.5 flex items-center justify-between shadow-sm">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            >
                                <svg className={cn("w-5 h-5 transition-transform duration-300", mobileMenuOpen && "rotate-90")} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div
                    className={cn(
                        "md:hidden fixed inset-0 z-[100] bg-black/50 backdrop-blur-sm transition-opacity duration-300 ease-out",
                ...
                <div
                    className={cn(
                        "md:hidden fixed top-0 left-0 z-[101] h-full w-[280px] bg-card shadow-2xl flex flex-col",
                        ...
                        {landingLinks.map((link, i) => {
                            ...
                            return (
                                <Link
                                    ...
                                    onClick={() => setMobileMenuOpen(false)}
                                    className={cn(
                                        "px-5 py-3.5 text-sm font-semibold tracking-wide uppercase transition-all duration-200",
                                        isActive
                                            ? "text-blue-600 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 border-l-[3px] border-blue-600 dark:border-blue-400"
                                            : "text-muted-foreground hover:text-foreground hover:bg-accent hover:pl-6 border-l-[3px] border-transparent"
                                    )}
                                    style={{
